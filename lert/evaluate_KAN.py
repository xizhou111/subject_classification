...
if __name__ == '__main__':
    ...
    # output_badclean_reduce_chinese_sampler_512/checkpoint-22000
    model_path = '/mnt/cfs/NLP/zcl/subjects_classification/lert/output_KAN_badclean_reduce_chinese_sampler_512/checkpoint-22000'
    ...
    model = SubjectClassificationBertModel.from_pretrained(model_path, 
                                                           num_labels=10,
                                                           id2label=id2label,
                                                           label2id=label2id,
                                                                )
    ...
    def compute_metrics(eval_pred):
        ...
        plt.savefig('./eval_output_pretrain_reduce_chinese_512/confusion_matrix.png')

        return results

    train_args = TrainingArguments(
        output_dir='./eval_output_pretrain_reduce_chinese_512',
