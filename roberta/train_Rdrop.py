...
# os.environ["CUDA_VISIBLE_DEVICES"] = "2"  # 选择GPU
...
def main():
    ...
    class SubjectClassificationTrainer(Trainer):
        ...
        # R-Drop loss computation
        def compute_loss(self, model, inputs, alpha=1.0, return_outputs=False):
            """
            R-Drop loss computation.
            """
            if "labels" in inputs:
            ...
            if labels is not None:
                ...
                loss1 = CrossEntropyLoss()(logits1, labels)
                loss2 = CrossEntropyLoss()(logits2, labels)
