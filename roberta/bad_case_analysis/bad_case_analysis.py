...
if __name__ == '__main__':
    ...
    checkpoint = '/mnt/cfs/NLP/zcl/subjects_classification/roberta/output_badclean_pretrain_reduce_chinese_sampler_512/checkpoint-18000'
    # model = AutoModelForSequenceClassification.from_pretrained(checkpoint, num_labels=10)
    # tokenizer = AutoTokenizer.from_pretrained(checkpoint, use_fast=True, max_length=256, padding="max_length", truncation=True)
