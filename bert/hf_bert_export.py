...
if __name__ == "__main__":
    output_lightseq_model_name = "lightseq_bert_base_chinese"
    input_huggingface_bert_model = "/mnt/cfs/NLP/zcl/subjects_classification/bert/bert_base_chinese_output/checkpoint-4400"
    head_number = 12
